...
Cora ($\Delta_{\max}=168$)
   & $0$       & $1.0\!\times\!10^{-14}$ & $0$ & ---
                & ---   & $317$ \\
   & $10^{-3}$ & $0.109$          & $3.1\!\times\!10^{4}$
                & $2.9\!\times\!10^{5}$ & $7.3$ & $317$ \\
   & $10^{-2}$ & $1.03$           & $3.1\!\times\!10^{5}$
                & $3.0\!\times\!10^{5}$ & $7.5$ & $317$ \\
   & $10^{-1}$ & $4.03$           & $3.1\!\times\!10^{6}$
                & $7.7\!\times\!10^{5}$ & $5.4$ & $317$ \\
   & $1.0$     & $46.9$           & $3.1\!\times\!10^{7}$
                & $6.6\!\times\!10^{5}$ & $5.0$ & $317$ \\
\midrule
CiteSeer ($\Delta_{\max}=99$)
   & $0$       & $9.2\!\times\!10^{-15}$ & $0$ & ---
                & ---   & $187$ \\
   & $10^{-3}$ & $0.088$          & $6.4\!\times\!10^{3}$
                & $7.3\!\times\!10^{4}$ & $6.7$ & $187$ \\
   & $10^{-2}$ & $0.787$          & $6.4\!\times\!10^{4}$
                & $8.2\!\times\!10^{4}$ & $6.7$ & $187$ \\
   & $10^{-1}$ & $6.49$           & $6.4\!\times\!10^{5}$
                & $9.9\!\times\!10^{4}$ & $7.3$ & $187$ \\
   & $1.0$     & $47.8$           & $6.4\!\times\!10^{6}$
                & $1.3\!\times\!10^{5}$ & $7.4$ & $187$ \\
\bottomrule
\end{tabular}
\caption{E3d: \cref{lem:mpnn-wl-robust} stress test on Cora and
CiteSeer at depth $L = 3$, hidden width $32$, Xavier-initialised
GIN weights. $D(L)$ is the empirical max embedding-diameter over
WL-equivalent pairs; $\delta_{L}$ is the lemma's worst-case
bound; $\gamma_{\mathrm{eff}}^{(L)} := (D(L)/D(0))^{1/L}$ is the
...
machine precision); the bound is loose by $5$--$6$ orders of
magnitude, because $1+\Delta_{\max}$ is the worst-case fan-in,
not the typical one. $\gamma_{\mathrm{eff}} \approx 5$--$7$
across both graphs and all noise scales, suggesting that an
...
real sparse graphs --- a $\approx 10^{5}\times$ improvement on
...
The combined picture from E3, E3b, E3c, E3d is: (i) the bracket
is correct everywhere it is evaluated; (ii) its informative
regime is exactly the coarse-partition regime that $\sigma > 0$
identifies; (iii) the cardinality collapse on ogbn-arxiv is
intrinsic to the graph and not a bracket pathology; and (iv)
the $\varepsilon$-robust lemma is the right shape but
quantitatively loose by a graph-dependent factor that future
mean-degree analyses should be able to close.
...
\Eqref{eq:pop-bracket} then follows from \eqref{eq:pop-concentration}
